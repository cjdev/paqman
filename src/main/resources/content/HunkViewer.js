define(["util"], function(util){
    return function(qual, hunk, userInfo, onEdit, where){
        var view = util.getTemplate('/HunkViewer.html'),
        ...
        function showProctoringMessage(){
            if(canProctor && hunk.kind === "challenge"){
                ...
                challengeMetEmblem.toggle(util.userHasMetChallenge(userInfo, hunk.id));
